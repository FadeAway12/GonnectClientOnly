...
int Board::bestMove(Stone color) const { // 1 move depth (lol) -> will improve later. returns a MOVE.
...
int Board::bestMove(Stone color, int depth) const { // 2 move depth (lol) -> will improve later. RETURNS A SCORE, NOT MOVE. HELPER!!!
